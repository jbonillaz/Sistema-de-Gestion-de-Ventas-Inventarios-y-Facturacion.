  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <div class="col-lg-5 col-xs-12">
            ...
            <div class="box-body">
              ...
              <div class="box">
                    ...
                    <?php 
                        ...
                        $venta = SalesController::ctrShowSales($item, $valor);

                        $itemUsuario = "id";
                        $valorUsuario = $venta["id_vendedor"];

                        $vendedor = ControllersUsers::ctrshowusers($itemUsuario, $valorUsuario);

                        $itemCliente = "id";
                        $valorCliente = $venta["id_cliente"];

                        $cliente = ControllerClient::ctrShowClient($itemCliente, $valorCliente);
                ...
                <div class="form-group row nuevoProducto">
                    ...
                    foreach ($listaProducto as $key => $value) {
                       ...
                       $respuesta = ControllerProducts::ctrShowProducts($item, $valor, $orden);
                        ...
                        <tr>
                          ...
                          <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" class="form-control input-lg" min="0" id="nuevoImpuestoVenta" name="nuevoImpuestoVenta" placeholder="0" value="<?php echo $porcentajeImpuesto; ?>" required>
                              
                              <input type="hidden" name="nuevoPrecioImpuesto" id="nuevoPrecioImpuesto" value="<?php echo $venta["neto"]; ?>" required>
                           ...
                           <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control input-lg" id="nuevoTotalVenta" name="nuevoTotalVenta" placeholder="00000" total="<?php echo $venta["neto"]; ?>" value="<?php echo $venta["total"]; ?>" readonly required>
        ...
        $editarVenta = new SalesController();
        $editarVenta -> ctrEditSale();
