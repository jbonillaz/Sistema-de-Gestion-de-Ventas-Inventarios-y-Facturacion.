                          ...
                          <td style="width: 50%">
                           ...
                           <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control input-lg" id="nuevoTotalVenta" name="nuevoTotalVenta" placeholder="00000" total="" value="<?php echo $venta["total"]; ?>" readonly required>
