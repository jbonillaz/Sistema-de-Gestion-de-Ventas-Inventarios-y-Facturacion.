...
$ventas = SalesController::ctrTotalSumSales();
...
<div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-aqua">
        ...
        <div class="icon">
            ...
            <a href="ventas" class="small-box-footer">Mas Información<i class="fa fa-arrow-circle-right"></i></a>
...
<div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-green">
        ...
        <div class="inner">
            ...
            <h3><?php echo number_format($totalCategorias); ?><sup style="font-size: 20px"></sup></h3>
